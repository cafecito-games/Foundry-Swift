...
public struct SignalMacro: DeclarationMacro {
    public static func expansion(
        ...
        for (index, argument) in node.arguments.enumerated() {
            ...
            if index == 1 {
                ...
                guard let dictSyntax = DictionaryExprSyntax(argument.expression) else {
                    throw FoundryMacroError.legacySignalMacroUnexpectedArgumentsSyntax
                }
        ...
        default:
            throw FoundryMacroError.legacySignalMacroTooManyArguments
        }
        
        let argumentList = ["\"" + signalName.foundryName + "\""] + arguments
            .enumerated()
