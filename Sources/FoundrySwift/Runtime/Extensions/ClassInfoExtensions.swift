...
extension UTType {
    /// The file type that corresponds to a Foundry resource file.
    public nonisolated(unsafe) static var foundryResource = UTType(filenameExtension: "res")

    /// The file type that corresponds to a Foundry scene file.
    ...
    /// The file type that corresponds to a Foundry tileset resource.
    public nonisolated(unsafe) static var foundryTilesetResource = UTType(filenameExtension: "tres")
}
#endif
...
extension ClassInfo {
    ...
    public static func withCheckedProperty(named name: String,
        ...
        guard let arg = arguments.first else {
            Foundry.pushError("Expected argument for \(name), but got nil instead.")
            return nil
        }
        action(arg)
        return nil
