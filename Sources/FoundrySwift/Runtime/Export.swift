...
func additionalRegistations (name: StringName) {
    // I guess this is to surface functions to Foundry, but not clear why should
    // having the function would be useful
    
//    if false {
//        let methodName = StringName ("_update")
//        
//        var argMeta = UnsafeMutableBufferPointer<FoundryExtensionClassMethodArgumentMetadata>.allocate(capacity: 1)
//        argMeta [0] = FOUNDRY_EXTENSION_METHOD_ARGUMENT_METADATA_NONE
//        
//        var argInfo = UnsafeMutableBufferPointer<FoundryExtensionPropertyInfo>.allocate(capacity: 1)
//        var updateName = StringName ("_update")
//        var none = GString ("Swift: no hint provided")
//        argInfo [0] = FoundryExtensionPropertyInfo(type: FOUNDRY_EXTENSION_VARIANT_TYPE_FLOAT,
...
//                
//                var minfo = FoundryExtensionClassMethodInfo ()
...
//                minfo.method_flags = UInt32((FOUNDRY_EXTENSION_METHOD_FLAG_VIRTUAL).rawValue)
