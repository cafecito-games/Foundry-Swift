//
//  MacroFoundryPropertyPropInfo.swift
//  FoundrySwift
//
...
public func _propInfo<Root, T>(
    ...
    userHintStr: String? = nil,
    userUsage: PropertyUsageFlags? = nil
) -> PropInfo where T: _FoundryBridgeableBuiltin {
    return T._propInfo(
        name: name,
        hint: userHint,
        hintStr: userHintStr,
...
@MainActor func makeArrayHint<Element>(_ type: Element.Type) -> String where Element: _FoundryContainerTypingParameter {
...
@MainActor public func _propInfo<Root, Element>(
    ...
    userHintStr: String? = nil,
    userUsage: PropertyUsageFlags? = nil
) -> PropInfo where Element: _FoundryContainerTypingParameter {
...
/// Internal API. Optional Builtin type. Facaded as Foundry Variant, because Foundry builtin types can't be nil, unlike objects.
@inline(__always)
@inlinable
