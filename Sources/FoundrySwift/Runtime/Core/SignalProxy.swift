...
/// register a method with foundry called `proxy` that will invoke
...
///
/// // Let foundry call `demo` and its proxy method.
...
public class SignalProxy: Object {
    ...
    /// The code invoked when Foundry invokes the `proxy` method on this object.
