...
/// A structure that houses a property that can be added to a Foundry inspector.
public struct InspectableProperty<T> {
    /// A typealias for the the method type used to register a property to Foundry for inspectors.
