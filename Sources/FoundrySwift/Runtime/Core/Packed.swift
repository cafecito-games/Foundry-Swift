...
extension PackedVector4Array : ExpressibleByArrayLiteral {
    ...
    public subscript (index: Int) -> Vector4 {
        get {
            guard let packedVector4ArrayOperatorIndexConst = gi.packed_vector4_array_operator_index_const else {
                fatalError("Foundry interface method 'packed_vector4_array_operator_index_const' was not available at runtime.")
            }
    ...
    public convenience init (_ data: [Vector4]) {
        ...
        guard let packedVector4ArrayOperatorIndex = gi.packed_vector4_array_operator_index else {
            fatalError("Foundry interface method 'packed_vector4_array_operator_index' was not available at runtime.")
        }
