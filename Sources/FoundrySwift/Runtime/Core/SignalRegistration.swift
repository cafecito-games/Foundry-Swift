...
/// - note: It is recommended to use the @Signal macro instead of using this directly.
@available(*, deprecated, message: "Use the @Signal macro instead.")
public struct SignalWith1Argument<Argument: _FoundryBridgeable>: @unchecked Sendable {
    public let name: StringName
...
public struct SignalWith2Arguments<
    Argument1: _FoundryBridgeable,
    Argument2: _FoundryBridgeable
>: @unchecked Sendable {
    public let name: StringName
    public let arguments: [PropInfo]
...
public extension Object {
    ...
    @discardableResult
    func emit(signal: SignalWithNoArguments) -> FoundryError {
    ...
    @discardableResult
    @available(*, deprecated, message: "Use the @Signal macro instead.")
    func connect(signal: SignalWithNoArguments, to target: some Object, method: String) -> FoundryError {
    ...
    @discardableResult
    @available(*, deprecated, message: "Use the @Signal macro instead.")
    func emit<A: _FoundryBridgeable>(signal: SignalWith1Argument<A>, _ argument: A) -> FoundryError {
    ...
    @discardableResult
    @available(*, deprecated, message: "Use the @Signal macro instead.")
    func connect(signal: SignalWith1Argument<some Any>, to target: some Object, method: String) -> FoundryError {
        connect(signal: signal.name, callable: .init(object: target, method: .init(method)))
    }
    ...
    @discardableResult
    @available(*, deprecated, message: "Use the @Signal macro instead.")
    func emit<A: _FoundryBridgeable, B: _FoundryBridgeable>(
    ...
    @discardableResult
    @available(*, deprecated, message: "Use the @Signal macro instead.")
    func connect(signal: SignalWith2Arguments<some Any, some Any>, to target: some Object, method: String) -> FoundryError {
        connect(signal: signal.name, callable: .init(object: target, method: .init(method)))
    }
    ...
    @discardableResult
    @available(*, deprecated, message: "Use the @Signal macro instead.")
    func emit<A: _FoundryBridgeable, B: _FoundryBridgeable, C: _FoundryBridgeable>(
    ...
    @discardableResult
    @available(*, deprecated, message: "Use the @Signal macro instead.")
    func emit<A: _FoundryBridgeable, B: _FoundryBridgeable, C: _FoundryBridgeable, D: _FoundryBridgeable>(
    ...
    @discardableResult
    @available(*, deprecated, message: "Use the @Signal macro instead.")
    func emit<A: _FoundryBridgeable, B: _FoundryBridgeable, C: _FoundryBridgeable, D: _FoundryBridgeable, E: _FoundryBridgeable>(
    ...
    @discardableResult
    @available(*, deprecated, message: "Use the @Signal macro instead.")
    func emit<A: _FoundryBridgeable, B: _FoundryBridgeable, C: _FoundryBridgeable, D: _FoundryBridgeable, E: _FoundryBridgeable, F: _FoundryBridgeable>(
...
extension PropInfo {
    fileprivate init(
        propertyType: (some _FoundryBridgeable).Type,
