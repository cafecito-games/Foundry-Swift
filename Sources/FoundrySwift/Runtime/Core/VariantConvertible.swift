...
public enum VariantConversionError: Error, CustomStringConvertible, @unchecked Sendable {
    ...
    /// Intended for ``FoundryBuiltinConvertible`` and ``VariantConvertible`` implementations of user.
...
/// Protocol for types that can be converted to and from ``Variant?`` aka `Foundry Variant`.
...
/// ```
///
/// All Foundry API types and all the primitive Swift types (such as ``Bool``, ``String``, ``Int``, ``UInt`` of any length, ``Float``, ``Double``) implement it.
...
/// Internal API. Protocol for types that contains details on how it interacts with C FoundryExtension API.
///
...
/// and is the only required subset of functionality required to interact with Foundry API, this protocol and ones that expand it contain information
/// required for low-level interaction with Foundry API.
/// You could assume that to be the set of all Builtin Types, Object-derived Types and Swift Variant.
public protocol _FoundryBridgeable: VariantConvertible {
    /// Internal API. Variant type tag for this type.
    static var _variantType: Variant.GType { get }
    
    /// Internal API. Name of this type in Foundry.  `Int64` -> `int`, `VariantArray` -> `Array`, `Object` -> `Object`
...
/// It means being a `_FoundryBridgeableBuiltin` also presumes being a `_FoundryContainerTypingParameter` so
/// the following declarations are legal:
/// ```
/// let array = TypedArray<Int>()
/// let dictionary = TypedDictionary<String, Vector3>()
/// ```
public protocol _FoundryBridgeableBuiltin: _FoundryContainerTypingParameter where _NonOptionalType == Self {
...
public extension _FoundryBridgeableBuiltin {
    /// Internal API. Required for cases where Foundry expects an empty `StringName` for builtin types and actual class name for `.object`-types.
    static var _className: StringName {
        StringName("")
    }
    
    /// Internal API. Returns Foundry type name for typed array.
    /// For example `TypedArray<Int>` is Foundry `Array[int]`
    @inline(__always)
    @inlinable
...
public extension _FoundryBridgeable where Self: Object {
    ...
    /// Internal API. Returns ``PropInfo`` for when any ``Object`` or its subclass instance is used as a property in API visible to Foundry
    @inline(__always)
    @inlinable
    static func _propInfo(
        name: String,
...
extension Int64: _FoundryBridgeableBuiltin {
    @inline(__always)
    ...
    public init?(_ variant: Variant) {
        ...
        withUnsafeMutablePointer(to: &self) { pPayload in
            variant.constructType(into: pPayload, constructor: VariantFoundryInterface.intFromVariant)
        }
    }
...
public extension BinaryInteger where Self: _FoundryBridgeableBuiltin {
    @inline(__always)
    @inlinable
    static func _fromRawArgument(_ ptr: UnsafeRawPointer) throws(ArgumentAccessError) -> Self {
...
extension Bool: _FoundryBridgeableBuiltin {
    @inline(__always)
    public static func _fromRawArgument(_ ptr: UnsafeRawPointer) throws(ArgumentAccessError) -> Self {
    ...
    /// Internal API. Returns ``PropInfo`` for when any ``Bool`` is used in API visible to Foundry
    @inline(__always)
    @inlinable
    ...
    public init?(_ variant: Variant) {
        guard Self._variantType == variant.gtype else { return nil }
        var payload: FoundryExtensionBool = 0
        withUnsafeMutablePointer(to: &payload) { pPayload in
            variant.constructType(into: pPayload, constructor: VariantFoundryInterface.boolFromVariant)
        }
...
extension String: _FoundryBridgeableBuiltin {
    @inline(__always)
    public static func _fromRawArgument(_ ptr: UnsafeRawPointer) throws(ArgumentAccessError) -> Self {
    ...
    public init?(_ variant: Variant) {
        ...
        case .string:
            ...
            variant.constructType(into: &content, constructor: FoundryInterfaceForString.selfFromVariant)
            self = GString.toString(pContent: &content)
            FoundryInterfaceForString.destructor(&content)
        case .stringName:
...
extension Double: _FoundryBridgeableBuiltin {
    @inline(__always)
    public static func _fromRawArgument(_ ptr: UnsafeRawPointer) throws(ArgumentAccessError) -> Self {
    ...
    public init?(_ variant: Variant) {
        ...
        withUnsafeMutablePointer(to: &self) { pPayload in
            variant.constructType(into: pPayload, constructor: VariantFoundryInterface.doubleFromVariant)
        }
    }
...
extension Int: _FoundryBridgeableBuiltin {}
extension Int32: _FoundryBridgeableBuiltin {}
extension Int16: _FoundryBridgeableBuiltin {}
extension Int8: _FoundryBridgeableBuiltin {}

extension UInt: _FoundryBridgeableBuiltin {}
extension UInt64: _FoundryBridgeableBuiltin {}
extension UInt32: _FoundryBridgeableBuiltin {}
extension UInt16: _FoundryBridgeableBuiltin {}
extension UInt8: _FoundryBridgeableBuiltin {}
    
extension Float: _FoundryBridgeableBuiltin {
    @inline(__always)
    public static func _fromRawArgument(_ ptr: UnsafeRawPointer) throws(ArgumentAccessError) -> Self {
...
public extension RawRepresentable where RawValue: BinaryInteger, RawValue: _FoundryBridgeableBuiltin {
    @inline(__always)
    @inlinable
    func toVariant() -> Variant {
        rawValue.toVariant()
...
public extension RawRepresentable where RawValue: BinaryFloatingPoint, RawValue: _FoundryBridgeableBuiltin  {
    @inline(__always)
    @inlinable
    func toVariant() -> Variant {
        rawValue.toVariant()
