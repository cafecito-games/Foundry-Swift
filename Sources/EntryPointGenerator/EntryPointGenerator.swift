...
struct EntryPointGenerator: ParsableCommand {
    ...
    @Argument(help: "Source files containing @Foundry classes to generate entry points for.")
    ...
    mutating func run() throws {
        ...
        let visitor = FoundryMacroSearchingVisitor(viewMode: .all, logger: verboseLogger)
