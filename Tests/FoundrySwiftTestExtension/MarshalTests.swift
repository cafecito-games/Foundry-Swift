...
final class MarshalTests {
    ...
    public func testVarargMethodsPerformance() {
        ...
        // Reduced iterations since we're not measuring performance
        for _ in 0..<100 {
            let maxVariant = Foundry.max(arg1: randomValues[0], arg2: randomValues[1], randomValues[2], randomValues[3], randomValues[4], randomValues[5], randomValues[6], randomValues[7], randomValues[8], randomValues[9])
