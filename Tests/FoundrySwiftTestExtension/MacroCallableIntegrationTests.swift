...
final class MacroCallableIntegrationTests {
    ...
    @FoundrySwiftTest
    public func testExplicitlyTypedObjectArrayFoundrySideMismatch() {
        let testObject = TestObject()
        ...
        // this one won't be added, error is logged from Foundry, RefCounted is not TestObject
    ...
    @FoundrySwiftTest
    public func testExplicitlyTypedBuiltinArrayFoundrySideMismatch() {
        let testObject = TestObject()
        ...
        builtinsArray.append(Variant(2))
        builtinsArray.append(Variant(3))
        // this one won't be added, error is logged from Foundry, nil Builtins are not allowed in typed Arrays
