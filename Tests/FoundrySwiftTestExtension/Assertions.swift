...
//
//  XCTest-compatible assertion functions for Foundry runtime tests
//
...
/// Asserts approximate equality of two floating point values based on Foundry's `Math::is_equal_approx`
@MainActor
