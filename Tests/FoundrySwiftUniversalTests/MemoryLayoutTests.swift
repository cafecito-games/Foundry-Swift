...
private extension MemoryLayoutTests {
    ...
    func getMetadata () throws -> ExtensionMetadata {
        ...
        let extensionApi = try JSONDecoder().decode (JFoundryExtensionAPI.self, from: data)
...
private extension MemoryLayoutTests {
    ...
    final class MemoryLayoutChecker<T> {
        ...
        private let sizeMetadata: JFoundrySize
        private let offsetMetadata: JFoundryBuiltinClassMemberOffsetClass
        ...
        init (_ type: T.Type, sizeMetadata: JFoundrySize, offsetMetadata: JFoundryBuiltinClassMemberOffsetClass) {
            self.type = type
    ...
    struct ExtensionMetadata {
        let sizes: [JFoundrySize]
        let offsets: [JFoundryBuiltinClassMemberOffsetClass]
    }
